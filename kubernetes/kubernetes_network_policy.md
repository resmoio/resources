...
| **Name**    | **Type**                                         | **Nullable** |
| ----------- | ------------------------------------------------ | ------------ |
| egress      | List<NetworkPolicySpec.NetworkPolicyEgressRule>  | &check;      |
| ingress     | List<NetworkPolicySpec.NetworkPolicyIngressRule> | &check;      |
| podSelector | LabelSelector                                    | &check;      |
| policyTypes | List<String>                                     | &check;      |

#### NetworkPolicySpec.IPBlock
| **Name** | **Type** | **Nullable** |
| -------- | -------- | ------------ |
| cidr     | String   | &check;      |
...
| **Name** | **Type**                                  | **Nullable** |
| -------- | ----------------------------------------- | ------------ |
| ports    | List<NetworkPolicySpec.NetworkPolicyPort> | &check;      |
| to       | List<NetworkPolicySpec.NetworkPolicyPeer> | &check;      |

#### NetworkPolicySpec.NetworkPolicyIngressRule
| **Name** | **Type**                                  | **Nullable** |
| -------- | ----------------------------------------- | ------------ |
| from     | List<NetworkPolicySpec.NetworkPolicyPeer> | &check;      |
| ports    | List<NetworkPolicySpec.NetworkPolicyPort> | &check;      |

#### NetworkPolicySpec.NetworkPolicyPeer
| **Name**          | **Type**                  | **Nullable** |
| ----------------- | ------------------------- | ------------ |
| ipBlock           | NetworkPolicySpec.IPBlock | &check;      |
| namespaceSelector | LabelSelector             | &check;      |
| podSelector       | LabelSelector             | &check;      |
