---
description: Kubernetes Cron Job
---
kubernetes_cron_job
-------------------
...
| **Name**                   | **Type**                    | **Nullable** |
| -------------------------- | --------------------------- | ------------ |
| concurrencyPolicy          | String                      | &check;      |
| failedJobsHistoryLimit     | Int                         | &check;      |
| jobTemplate                | CronJobSpec.JobTemplateSpec | &check;      |
| schedule                   | String                      | &check;      |
| startingDeadlineSeconds    | Long                        | &check;      |
| successfulJobsHistoryLimit | Int                         | &check;      |
| suspend                    | Boolean                     | &check;      |

#### CronJobSpec.JobSpec
| **Name**                | **Type**        | **Nullable** |
| ----------------------- | --------------- | ------------ |
| activeDeadlineSeconds   | Long            | &check;      |
| backoffLimit            | Int             | &check;      |
| completions             | Int             | &check;      |
| manualSelector          | Boolean         | &check;      |
| parallelism             | Int             | &check;      |
| selector                | LabelSelector   | &check;      |
| template                | PodTemplateSpec | &check;      |
| ttlSecondsAfterFinished | Int             | &check;      |

#### CronJobSpec.JobTemplateSpec
| **Name** | **Type**            | **Nullable** |
| -------- | ------------------- | ------------ |
| metadata | ObjectMeta          | &check;      |
| spec     | CronJobSpec.JobSpec | &check;      |
