...
| spec     | ServiceSpec   | &cross;      |
| status   | ServiceStatus | &check;      |
...
| **Name**                 | **Type**                          | **Nullable** |
| ------------------------ | --------------------------------- | ------------ |
| clusterIP                | String                            | &check;      |
| externalIps              | List<String>                      | &check;      |
| externalName             | String                            | &check;      |
| externalTrafficPolicy    | String                            | &check;      |
| healthCheckNodePort      | Int                               | &check;      |
| loadBalancerIP           | String                            | &check;      |
| loadBalancerSourceRanges | List<String>                      | &check;      |
| ports                    | List<ServiceSpec.ServicePort>     | &check;      |
| publishNotReadyAddresses | Boolean                           | &check;      |
| selector                 | Map<String,String>                | &check;      |
| sessionAffinity          | String                            | &check;      |
| sessionAffinityConfig    | ServiceSpec.SessionAffinityConfig | &check;      |
| type                     | String                            | &check;      |
...
| port       | Int      | &check;      |
| protocol   | String   | &check;      |
| targetPort | String   | &check;      |

#### ServiceSpec.SessionAffinityConfig
| **Name** | **Type**                                         | **Nullable** |
| -------- | ------------------------------------------------ | ------------ |
| clientIP | ServiceSpec.SessionAffinityConfig.ClientIPConfig | &check;      |

#### ServiceSpec.SessionAffinityConfig.ClientIPConfig
| **Name**       | **Type** | **Nullable** |
| -------------- | -------- | ------------ |
| timeoutSeconds | Int      | &check;      |
...
| **Name**     | **Type**                         | **Nullable** |
| ------------ | -------------------------------- | ------------ |
| loadBalancer | ServiceStatus.LoadBalancerStatus | &check;      |

#### ServiceStatus.LoadBalancerStatus
| **Name** | **Type**                                                   | **Nullable** |
| -------- | ---------------------------------------------------------- | ------------ |
| ingress  | List<ServiceStatus.LoadBalancerStatus.LoadBalancerIngress> | &check;      |

#### ServiceStatus.LoadBalancerStatus.LoadBalancerIngress
| **Name** | **Type** | **Nullable** |
| -------- | -------- | ------------ |
| hostname | String   | &check;      |
| ip       | String   | &check;      |
