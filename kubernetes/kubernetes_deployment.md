...
| **Name**                | **Type**                          | **Nullable** |
| ----------------------- | --------------------------------- | ------------ |
| minReadySeconds         | Int                               | &check;      |
| paused                  | Boolean                           | &check;      |
| progressDeadlineSeconds | Int                               | &check;      |
| replicas                | Int                               | &check;      |
| revisionHistoryLimit    | Int                               | &check;      |
| selector                | LabelSelector                     | &check;      |
| strategy                | DeploymentSpec.DeploymentStrategy | &check;      |
| template                | PodTemplateSpec                   | &check;      |

#### DeploymentSpec.DeploymentStrategy
| **Name**      | **Type**                               | **Nullable** |
| ------------- | -------------------------------------- | ------------ |
| rollingUpdate | DeploymentSpec.RollingUpdateDeployment | &check;      |
| type          | String                                 | &check;      |

#### DeploymentSpec.RollingUpdateDeployment
| **Name**       | **Type** | **Nullable** |
| -------------- | -------- | ------------ |
| maxSurge       | String   | &check;      |
| maxUnavailable | String   | &check;      |
