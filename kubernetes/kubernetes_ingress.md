...
| spec     | IngressSpec   | &check;      |
| status   | IngressStatus | &check;      |
...
| **Name** | **Type**                                 | **Nullable** |
| -------- | ---------------------------------------- | ------------ |
| resource | IngressBackend.TypedLocalObjectReference | &check;      |
| service  | IngressBackend.IngressServiceBackend     | &check;      |

#### IngressBackend.IngressServiceBackend
| **Name** | **Type**                                                | **Nullable** |
| -------- | ------------------------------------------------------- | ------------ |
| name     | String                                                  | &check;      |
| port     | IngressBackend.IngressServiceBackend.ServiceBackendPort | &check;      |
...
#### IngressBackend.TypedLocalObjectReference
| **Name** | **Type** | **Nullable** |
| -------- | -------- | ------------ |
...
| -------- | -------------------------------- | ------------ |
| host     | String                           | &check;      |
| http     | IngressRule.HTTPIngressRuleValue | &check;      |

#### IngressRule.HTTPIngressRuleValue
| **Name** | **Type**                                               | **Nullable** |
| -------- | ------------------------------------------------------ | ------------ |
| paths    | List<IngressRule.HTTPIngressRuleValue.HTTPIngressPath> | &check;      |

#### IngressRule.HTTPIngressRuleValue.HTTPIngressPath
| **Name** | **Type**       | **Nullable** |
| -------- | -------------- | ------------ |
| backend  | IngressBackend | &check;      |
| path     | String         | &check;      |
| pathType | String         | &check;      |

#### IngressSpec
| **Name**         | **Type**          | **Nullable** |
| ---------------- | ----------------- | ------------ |
| defaultBackend   | IngressBackend    | &check;      |
| ingressClassName | String            | &check;      |
| rules            | List<IngressRule> | &check;      |
| tls              | List<IngressTLS>  | &check;      |

#### IngressStatus
| **Name**     | **Type**                         | **Nullable** |
| ------------ | -------------------------------- | ------------ |
| loadBalancer | IngressStatus.LoadBalancerStatus | &check;      |

#### IngressStatus.LoadBalancerStatus
| **Name** | **Type**                                                   | **Nullable** |
| -------- | ---------------------------------------------------------- | ------------ |
| ingress  | List<IngressStatus.LoadBalancerStatus.LoadBalancerIngress> | &check;      |

#### IngressStatus.LoadBalancerStatus.LoadBalancerIngress
| **Name** | **Type** | **Nullable** |
| -------- | -------- | ------------ |
